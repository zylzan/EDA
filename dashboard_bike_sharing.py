...
@st.cache_resource
def load_data():
    data = pd.read_csv("https://raw.githubusercontent.com/zylzan/EDA/main/hour.csv")
    return data
...
# ==============================
# Set page title
st.title("Bike Sharing Dashboard by Fauzan")

# ==============================
# SIDEBAR
# ==============================
st.sidebar.title("Information:")
st.sidebar.markdown("**• Nama: Fauzani Lufti**")
st.sidebar.markdown(
    "**• Email: [fauzanilufti@gmail.com](fauzanilufti@gmail.com)**")
...
# Show dataset source
st.sidebar.markdown("[Download Dataset](https://github.com/zylzan/EDA)")
